...
BROWSER_SOURCES = [
    ...
    {"name": "Товарна біржа ЕТС",
     ...
     "keywords": ["право вимоги", "кредитн", "портфель", "дебіторськ"]},
    {"name": "EAuction (Open Tender)",
     "url": "https://eauction.open-tender.com.ua/",
     "keywords": ["право вимоги", "кредитн", "портфель", "дебіторськ"]},
    {"name": "Tender-Online",
     "url": "https://tender-online.com.ua/",
     "keywords": ["право вимоги", "кредитн", "портфель", "дебіторськ"]},
    {"name": "Invest.UA — ProZorro",
     "url": "https://invest.ua/prozorro-prodazhi/",
     "keywords": ["право вимоги", "кредитн", "портфель", "дебіторськ", "приватизація"]},
    # === ФК / Колектори (перепродаж портфелів) ===
    {"name": "УкрБорг (колектор)",
     "url": "https://ukrborg.ua/",
     "keywords": ["продаж", "портфель", "право вимоги", "відступлення", "факторинг"]},
    {"name": "ФК Форінт",
     "url": "https://forint.com.ua/",
