...
celery_app.conf.update(
    ...
    include=[
        ...
        "app.tasks.bankruptcy_tasks",
        "app.tasks.export_tasks",
    ],
)

# Periodic tasks — daily at 02:00–04:00 Kyiv time
celery_app.conf.beat_schedule = {
    "daily-bankruptcy-check": {
        "task": "app.tasks.bankruptcy_tasks.batch_bankruptcy_check",
    ...
    "daily-court-decisions-sync": {
        "task": "app.tasks.parsing_tasks.sync_new_decisions",
